...
import UncertainGantt.Script.ConsoleInterpreter qualified as ConsoleInterpreter
import UncertainGantt.Script.Parser (parseScript)
import UncertainGantt.Script.StatementInterpreter (interpretStream)
import UncertainGantt.Script.Types (MoreInputExpected (..), Statement (..))

-- | Run a script using the streaming interpreter
runScript :: Text.Text -> IO ConsoleInterpreter.ConsoleInterpreter
...
runScriptWith ::
  ...
  IO ConsoleInterpreter.ConsoleInterpreter
